...
class AnimatePage extends StatefulWidget {
  ...
  @override
  _MyAnimatePageState createState() => _MyAnimatePageState();
}

class _MyAnimatePageState extends State<AnimatePage> {
            ...
            Row(
              ...
              children: <Widget>[
                ...
                RotateAnimatedTextKit(
                  ...
                  totalRepeatCount: 10,
                  text: ['ORIENTER', 'RAPPELER', 'RECOMPENSER'],
                  textStyle: const TextStyle(
                      fontSize: 40.0,
                      fontWeight: FontWeight.bold,
                      fontFamily: 'EcoRegular',
