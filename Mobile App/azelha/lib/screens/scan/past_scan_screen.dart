...
class PastScanScreen extends StatefulWidget {
  @override
  _PastScanScreenState createState() => _PastScanScreenState();
}

class _PastScanScreenState extends State<PastScanScreen> {
  User _user;
  Addresss _address;
  ...
  Future<List<Scan>> retrievePastScanByStatusFromBackend() async {
    _customerScanBloc.initPastScanByStatusData(
        _address.id, "COMPLETED", "FAILED");
    itemList = await _customerScanBloc.pastScanController.first;
    return itemList;
  }
